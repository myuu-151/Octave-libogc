...
int Video3D_Lua::SetVideoClip(lua_State* L)
{
    Video3D* node = CHECK_VIDEO_3D(L, 1);
...
int Video3D_Lua::GetVideoClip(lua_State* L)
{
    Video3D* node = CHECK_VIDEO_3D(L, 1);
...
int Video3D_Lua::PlayVideo(lua_State* L)
{
    Video3D* node = CHECK_VIDEO_3D(L, 1);
...
int Video3D_Lua::PauseVideo(lua_State* L)
{
    Video3D* node = CHECK_VIDEO_3D(L, 1);
...
int Video3D_Lua::StopVideo(lua_State* L)
{
    Video3D* node = CHECK_VIDEO_3D(L, 1);
...
int Video3D_Lua::SeekVideo(lua_State* L)
{
    Video3D* node = CHECK_VIDEO_3D(L, 1);
...
int Video3D_Lua::IsPlaying(lua_State* L)
{
    Video3D* node = CHECK_VIDEO_3D(L, 1);
...
int Video3D_Lua::GetPlayTime(lua_State* L)
{
    Video3D* node = CHECK_VIDEO_3D(L, 1);
...
int Video3D_Lua::GetDuration(lua_State* L)
{
    Video3D* node = CHECK_VIDEO_3D(L, 1);
...
int Video3D_Lua::SetLoop(lua_State* L)
{
    Video3D* node = CHECK_VIDEO_3D(L, 1);
...
int Video3D_Lua::GetLoop(lua_State* L)
{
    Video3D* node = CHECK_VIDEO_3D(L, 1);
...
int Video3D_Lua::SetAutoPlay(lua_State* L)
{
    Video3D* node = CHECK_VIDEO_3D(L, 1);
    bool value = CHECK_BOOLEAN(L, 2);
...
int Video3D_Lua::GetAutoPlay(lua_State* L)
{
    Video3D* node = CHECK_VIDEO_3D(L, 1);
...
int Video3D_Lua::SetVolume(lua_State* L)
{
    Video3D* node = CHECK_VIDEO_3D(L, 1);
...
int Video3D_Lua::GetVolume(lua_State* L)
{
    Video3D* node = CHECK_VIDEO_3D(L, 1);
...
int Video3D_Lua::SetAudioEnabled(lua_State* L)
{
    Video3D* node = CHECK_VIDEO_3D(L, 1);
    bool value = CHECK_BOOLEAN(L, 2);
...
int Video3D_Lua::IsAudioEnabled(lua_State* L)
{
    Video3D* node = CHECK_VIDEO_3D(L, 1);
...
int Video3D_Lua::GetVideoTexture(lua_State* L)
{
    Video3D* node = CHECK_VIDEO_3D(L, 1);

    Asset_Lua::Create(L, node->GetVideoTexture());
    return 1;
}

void Video3D_Lua::Bind()
{
    lua_State* L = GetLua();
    ...
    REGISTER_TABLE_FUNC(L, mtIndex, GetVideoTexture);
